...
namespace WindowsFormsLogin
{
    ...
    public partial class frmLogin : Form
    {
        ...
        private void frmLogin_Load(object sender, EventArgs e)
        {
            ...
            saveFileDialogJson.InitialDirectory = @"C:\___Corsi\HTML\RegProvCom\JSON";
            saveFileDialogJson.Filter = "JSON files|*.json";
            saveFileDialogJson.RestoreDirectory = true;

            openFileDialogJson.InitialDirectory = @"C:\___Corsi\HTML\RegProvCom\JSON";
        ...
        private void buttonObjectComune_Click(object sender, EventArgs e)
        {
            ...
            List<Comune> listComuni = JsonConvert.DeserializeObject<List<Comune>>(strJson);

            foreach (Comune com in listComuni)
            {
        ...
        /// <summary>
        /// Byte[] 
        /// https://stackoverflow.com/questions/18764155/open-byte-array-as-file-windows-forms
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void buttonJsonComuneByte_Click(object sender, EventArgs e)
        {
            oDL = new ListeDati(_logger);
            List<Comune> listComuni = oDL.LoadComune();
            ...
            if (saveFileDialogJson.ShowDialog() == DialogResult.OK)
            {
                string tempFolder = saveFileDialogJson.InitialDirectory;
                // string fileName = System.IO.Path.Combine(tempFolder, "DatiComuniBYTE.json");
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void buttonObjectComuneByte_Click(object sender, EventArgs e)
        {
            string strJson = string.Empty;
            string fileName = "DatiComuniBYTE.json";
            openFileDialogJson.FileName = fileName;
            if (openFileDialogJson.ShowDialog() == DialogResult.OK)
            {
                ...
                strJson = Encoding.UTF8.GetString(data, 0, data.Length);
